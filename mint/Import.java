...
public class Import {
    ...
    public static MintObject importSystem() {
        MintObject mo = new MintObject();
        Subprogram getArgs = new Subprogram("getArgs", new SmartList<Pointer>(),
                                            new GetArgs());
        mo.put("exit", Heap.allocateSub(
               new Subprogram("exit", new SmartList<Pointer>(), new Exit())));
